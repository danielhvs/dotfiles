...
(let [handlers {"textDocument/publishDiagnostics"
      ...
      on_attach (fn [client bufnr]
                  (do
                    ...
                    ;telescope
                    (nvim.buf_set_keymap bufnr :n :<leader>la ":Telescope lsp_code_actions<cr>" {:noremap true})
                    ; (nvim.buf_set_keymap bufnr :v :<leader>la ":lua require('telescope.builtin').lsp_range_code_actions()<cr>" {:noremap true})
