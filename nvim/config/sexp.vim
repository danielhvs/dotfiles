...
function! s:sexp_mappings() abort
  ...
  nmap <buffer> <M-S-l>  mm<Plug>(sexp_capture_next_element)`m
  nmap <buffer> <M-S-h>  mm<Plug>(sexp_capture_prev_element)`m
  nmap <buffer> <M-S-j>  mm<Plug>(sexp_emit_head_element)`m
  nmap <buffer> <M-S-k>  mm<Plug>(sexp_emit_tail_element)`m
endfunction
