...
nnoremap <localleader>rt mm:ConjureEvalRootForm<CR>?deftest<CR>$B"yyiwO(clojure.test/run-test <C-R>y)<ESC><CR>k0l:redraw<CR>:ConjureEvalCurrentForm<CR>dd:update<CR>`m
