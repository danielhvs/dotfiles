...
nnoremap <localleader>rt :ConjureEvalBuf<CR>?deftest<CR>$B"yyiw<ESC>"dddGo<CR>(comment (clojure.test/run-test <C-R>y))<ESC>:redraw<CR>F(lmAma:ConjureEvalCurrentForm<CR>:update<CR>
